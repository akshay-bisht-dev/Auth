...
const Regsitration = () => {
  ...
  return (
    // <form className="flex my-5 flex-col gap-5">
    ...
    //     <input autoComplete="off" placeholder="Enter Your Pasword..." />
    //   </div>
    ...
    //   <button className="bg-green-700 py-2 justify-center flex text-white">
    //     Sign up
    //   </button>
    //   <p className="text-center font-bold">OR</p>
    //   <button
    //     className="bg-red-600 py-2 justify-center flex text-white"
    //     onClick={() => toggleBtn()}
    //   >
